...
export async function generateMetadata() {
  ...
  return {
    title: `${t('greetingTitle')} | PARIZOD`,
    description: t('aboutStoreDescription'),
    keywords: 'о бренде, PARIZOD, женская одежда, история бренда, преимущества, блог о моде, дар бораи бренд',
    openGraph: {
      title: `${t('greetingTitle')} | PARIZOD`,
      description: t('aboutStoreDescription'),
      images: ['/images/og-image.jpg'],
      url: 'https://shikshop.vercel.app/about',
    },
    robots: 'index, follow',
  };
}
