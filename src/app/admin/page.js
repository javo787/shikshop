      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link href="/admin/javo" className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-all flex flex-col items-center justify-center text-center group">
           ...
           <Link href="/admin/orders" className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-all flex flex-col items-center justify-center text-center group">
            <span className="text-4xl mb-2 group-hover:scale-110 transition-transform">📝</span>
            <span className="font-bold text-dark-teal">Заказы</span>
          </Link>
         ...
         <Link href="/admin/newsletter" className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-all flex flex-col items-center justify-center text-center group">
            <span className="text-4xl mb-2 group-hover:scale-110 transition-transform"></span>
            <span className="font-bold text-dark-teal">Рассылка</span>
          </Link>
